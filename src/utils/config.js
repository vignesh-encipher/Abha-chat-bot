...
export const pdfControl = process.env.NEXT_PUBLIC_PORTAL_BASE_URL + "em/report/getfile/bytes";
export const buildIdGen = process.env.NEXT_PUBLIC_BUILD_ID
export const isShowPdfMozilla = process.env.NEXT_PUBLIC_PDF_SHOW_MOZILLA
